...
public class JEditTextArea extends JComponent implements UndoableEditListener,
	...
	private boolean _discardEditsOnSet = true;
	...
	public void focusGained(FocusEvent fe) {
		if (isEditable() && _undoManager == null) {
			createUndoMananger();
		}
	}
	...
	public void setText(String text) {
		...
		if (_discardEditsOnSet && _undoManager != null) {
	 ...
	 */
	public JEditTextArea setSelectedText(String selectedText) {
		if (!editable) {
	...
	class MutableCaretEvent extends CaretEvent {
		private static final long serialVersionUID = -3260323949781319543L;
	...
	class CaretUndo extends AbstractUndoableEdit {
		...
		private static final long serialVersionUID = -3125719667070197952L;
		private int start;
		private int end;
