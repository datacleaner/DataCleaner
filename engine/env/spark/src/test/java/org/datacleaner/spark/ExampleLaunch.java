...
public class ExampleLaunch {
    ...
    private static final String DATA_LOCATION = "/datacleaner/test/person_data.txt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        launcher.copyFileToHdfs(new File("src/test/resources/person_data.json"), DATA_LOCATION, false);
