...
public class StringAnalysisProfile extends AbstractProfile {
	...
	protected List<IMatrix> getResultMatrices() {
		...
		for (int i = 0; i < _columns.length; i++) {
			...
			MatrixValue[] matrixValues = mb.addColumn(columnName, numChars,
					maxChars, minChars, numUppercase, numLowercase,
					numNonletter, numWords, maxWords, minWords);
