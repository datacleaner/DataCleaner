 ...
 */
package org.datacleaner.panels.updatedatahub;
...
import org.datacleaner.beans.writers.UpdateDataHubAnalyzer;
 ...
 */
class UpdateDataHubJobBuilderPresenter extends AnalyzerComponentBuilderPanel {
    ...
    public UpdateDataHubJobBuilderPresenter(AnalyzerComponentBuilder<UpdateDataHubAnalyzer> ajb,
            WindowContext windowContext, PropertyWidgetFactory propertyWidgetFactory,
            DataCleanerConfiguration configuration, DCModule dcModule) {
        super(ajb, propertyWidgetFactory);
        _overriddenPropertyWidgets = new HashMap<ConfiguredPropertyDescriptor, PropertyWidget<?>>();

        final AnalyzerDescriptor<UpdateDataHubAnalyzer> descriptor = ajb.getDescriptor();
        assert descriptor.getComponentClass() == UpdateDataHubAnalyzer.class;
        ...
        final SingleDatastorePropertyWidget datastorePropertyWidget = new SingleDatastorePropertyWidget(
                ajb, _datastoreProperty, configuration.getDatastoreCatalog(), dcModule);
        ...
        final SchemaNamePropertyWidget schemaNamePropertyWidget = new SchemaNamePropertyWidget(ajb,
                _schemaNameProperty);
        ...
        final SingleTableNamePropertyWidget tableNamePropertyWidget = new SingleTableNamePropertyWidget(
                ajb, _tableNameProperty, windowContext);
        ...
        // values
        {
            ...
            final MultipleMappedColumnsPropertyWidget inputColumnsPropertyWidget = new MultipleMappedPrefixedColumnsPropertyWidget(
                    ajb, _valueInputColumnsProperty, _valueColumnNamesProperty, " → ");
        ...
        // condition values
        {
            ...
            final MultipleMappedColumnsPropertyWidget inputColumnsPropertyWidget = new MultipleMappedPrefixedColumnsPropertyWidget(
                    ajb, _conditionInputColumnsProperty, _conditionColumnNamesProperty, " = ");
