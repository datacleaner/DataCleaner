...
public class ReferenceDataMatcherAnalyzerTest extends TestCase {
    ...
    private final SynonymCatalog sc1 = new SimpleSynonymCatalog("Geek language", new SimpleSynonym("foobar", "foo",
            "bar", "baz"), new SimpleSynonym("hello world", "hello", "world"), new SimpleSynonym("lorem ipsum",
            "lorem", "ipsum", "dolor"));
    private final SynonymCatalog sc2 = new SimpleSynonymCatalog("Name genders", new SimpleSynonym("male", "jack",
            "joe", "kim"), new SimpleSynonym("female", "jane", "barbara", "kim"));
    ...
    public void testMultipleColumnsDictionariesStringPatterns() throws Exception {
        ...
        final ReferenceDataMatcherAnalyzer analyzer = new ReferenceDataMatcherAnalyzer(columns, dictionaries, null,
                stringPatterns, new DataCleanerConfigurationImpl());
    ...
    public void testDictionariesAndSynonymCatalogs() throws Exception {
        ReferenceDataMatcherAnalyzer analyzer = new ReferenceDataMatcherAnalyzer(
                new InputColumn[] { column1, column2 }, new Dictionary[] { dict1 }, new SynonymCatalog[] { sc1, sc2 },
                new StringPattern[] { sp1 }, new DataCleanerConfigurationImpl());
