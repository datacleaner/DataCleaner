...
public class DensityAnalyzerResultRevised implements AnalyzerResult {
    ...
    public DensityAnalyzerResultRevised(Map<Point, RowAnnotation> annotations, InputColumn<Number> variable1,
