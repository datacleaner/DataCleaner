...
public class ExampleLaunch {
    ...
    private static final String JOB_LOCATION = "/datacleaner/test/json-job.analysis.com";
    ...
    public static void main(String[] args) throws Exception {
        ...
        launcher.copyFileToHdfs(new File("src/test/resources/json_online.json"), DATA_LOCATION, false);
        launcher.copyFileToHdfs(new File("src/test/resources/conf_hdfs.xml"), CONFIGURATION_LOCATION, false);
        launcher.copyFileToHdfs(new File("src/test/resources/distributable-grouped-value-dist.analysis.xml"), JOB_LOCATION, false);
