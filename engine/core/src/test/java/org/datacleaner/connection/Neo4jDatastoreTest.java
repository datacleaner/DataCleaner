...
public class Neo4jDatastoreTest {
    ...
    public void testDatastore() {
        ...
        assertEquals("Neo4jDatastore[name=TheNeo4j, hostname=localhost, port=7474, _username=neo4j]",
                neo4jDatastore.toString());
    ...
    public void testDatastoreWithPort() {
        ...
        assertEquals("neo4j", neo4jDatastore.getUsername());
        assertEquals("neo4j", neo4jDatastore.getPassword());
        assertEquals("Neo4jDatastore[name=TheNeo4j, hostname=localhost, port=8080, _username=neo4j]",
                neo4jDatastore.toString());
    }
