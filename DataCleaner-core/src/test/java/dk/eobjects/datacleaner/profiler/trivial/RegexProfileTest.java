	...
	public void testSeveralColumns() throws Exception {
		...
		assertEquals(
				"Matrix[columnNames={LASTNAME,EMAIL,JOBTITLE},"
						+ "email={0,MatrixValue[value=23,detailQuery=SELECT _EMPLOYEES_._EMPLOYEENUMBER_, _EMPLOYEES_._LASTNAME_, _EMPLOYEES_._FIRSTNAME_, _EMPLOYEES_._EXTENSION_, _EMPLOYEES_._EMAIL_, _EMPLOYEES_._OFFICECODE_, _EMPLOYEES_._REPORTSTO_, _EMPLOYEES_._JOBTITLE_ FROM PUBLIC._EMPLOYEES_],0},a single word={MatrixValue[value=23,detailQuery=SELECT _EMPLOYEES_._EMPLOYEENUMBER_, _EMPLOYEES_._LASTNAME_, _EMPLOYEES_._FIRSTNAME_, _EMPLOYEES_._EXTENSION_, _EMPLOYEES_._EMAIL_, _EMPLOYEES_._OFFICECODE_, _EMPLOYEES_._REPORTSTO_, _EMPLOYEES_._JOBTITLE_ FROM PUBLIC._EMPLOYEES_],0,MatrixValue[value=1,detailQuery=SELECT _EMPLOYEES_._EMPLOYEENUMBER_, _EMPLOYEES_._LASTNAME_, _EMPLOYEES_._FIRSTNAME_, _EMPLOYEES_._EXTENSION_, _EMPLOYEES_._EMAIL_, _EMPLOYEES_._OFFICECODE_, _EMPLOYEES_._REPORTSTO_, _EMPLOYEES_._JOBTITLE_ FROM PUBLIC._EMPLOYEES_]},No Matches={0,0,MatrixValue[value=22,detailQuery=SELECT _EMPLOYEES_._EMPLOYEENUMBER_, _EMPLOYEES_._LASTNAME_, _EMPLOYEES_._FIRSTNAME_, _EMPLOYEES_._EXTENSION_, _EMPLOYEES_._EMAIL_, _EMPLOYEES_._OFFICECODE_, _EMPLOYEES_._REPORTSTO_, _EMPLOYEES_._JOBTITLE_ FROM PUBLIC._EMPLOYEES_]},Multiple Matches={0,0,0}]",
				matrices[0].toString().replace('"', '_'));
