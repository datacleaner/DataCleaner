 ...
 */
public abstract class AbstractDataCleanerJobContext implements DataCleanerJobContext {
    ...
    public AbstractDataCleanerJobContext(TenantContext tenantContext, RepositoryFile file) {
    ...
    @Override
    public abstract MetricJobEngine<? extends MetricJobContext> getJobEngine(); 
