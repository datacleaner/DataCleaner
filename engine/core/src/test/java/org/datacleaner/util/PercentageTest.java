...
public class PercentageTest extends TestCase {
    ...
    public void testParsePercentage() throws Exception {
        ...
        percentage = Percentage.parsePercentage("95%");
        assertEquals(0.95, percentage.doubleValue());
        percentage = Percentage.parsePercentage("0%");
        assertEquals(0.0, percentage.doubleValue());
        percentage = Percentage.parsePercentage("100%");
        assertEquals(1.0, percentage.doubleValue());
        percentage = Percentage.parsePercentage("4%");
        assertEquals(0.04, percentage.doubleValue());
