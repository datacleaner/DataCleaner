...
public interface WizardServiceAsync {
    ...
    void getJobWizardIdentifiers(TenantIdentifier tenant, AsyncCallback<List<WizardIdentifier>> callback);
    ...
    void startDatastoreWizard(TenantIdentifier tenant, WizardIdentifier wizard, String datastoreName,
