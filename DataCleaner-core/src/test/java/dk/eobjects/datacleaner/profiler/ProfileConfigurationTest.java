...
public class ProfileConfigurationTest extends DataCleanerTestCase {
	...
	public void testDeserializeAndSerialize() throws Exception {
		...
		assertEquals(
				"<?xml version=_1.0_ encoding=_UTF-8_?><configuration profileClass=_dk.eobjects.datacleaner.profiler.trivial.StandardMeasuresProfile_><property name=_foo1_>bar1</property><property name=_foo2_>bar2</property><column schema=_PUBLIC_ table=_CUSTOMERS_>CUSTOMERNAME</column><column schema=_PUBLIC_ table=_CUSTOMERS_>PHONE</column></configuration>",
