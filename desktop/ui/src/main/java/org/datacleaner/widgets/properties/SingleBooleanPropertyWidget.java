...
public class SingleBooleanPropertyWidget extends AbstractPropertyWidget<Boolean> {
    ...
    @Inject
    public SingleBooleanPropertyWidget(final ConfiguredPropertyDescriptor propertyDescriptor,
            final ComponentBuilder componentBuilder) {
        super(componentBuilder, propertyDescriptor);

        final Boolean currentValue = getCurrentValue();

        final boolean useCheckBox = propertyDescriptor.isRequired() || propertyDescriptor.getBaseType().isPrimitive();
