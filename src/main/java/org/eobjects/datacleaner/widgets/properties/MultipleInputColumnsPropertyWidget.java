...
public class MultipleInputColumnsPropertyWidget extends DCPanel implements PropertyWidget<InputColumn<?>[]>,
	...
	private boolean isEnabled(InputColumn<?> inputColumn, InputColumn<?>[] currentValue) {
		if (currentValue == null || currentValue.length == 0) {
			...
			BeanDescriptor<?> beanDescriptor = _propertyDescriptor.getBeanDescriptor();
