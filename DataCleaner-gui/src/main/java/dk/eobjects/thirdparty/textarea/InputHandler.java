 ...
 * @see dk.eobjects.thirdparty.textarea.DefaultInputHandler 08/12/2002 Clipboard
 *      actions (Oliver Henning)
 */
...
public abstract class InputHandler extends KeyAdapter {
	...
	public static class insert_tab implements ActionListener {
		public void actionPerformed(ActionEvent evt) {
			...
			if (startLine < endLine) {
				...
				textArea.setSelectionStart(textArea
						.getLineStartOffset(startLine));
				textArea.setSelectionEnd(textArea.getLineEndOffset(endLine));
			} else {
	...
	public static class undo implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			UndoManager undoManager = textArea.getUndoManager();
			try {
				if (undoManager != null) {
					undoManager.undo();
				}
