...
public class BooleanAnalyzerReducerTest {
    ...
    public void test() throws Throwable {
        ...
        final BooleanAnalyzerResult partialResult2 = getPartialResult(jobBuilder2, 6, 10);
        final BooleanAnalyzerResult partialResult3 = getPartialResult(jobBuilder3, 11, 15);
    ...
    private BooleanAnalyzerResult getPartialResult(AnalysisJobBuilder jobBuilder, Integer firstRow, Integer maxRows)
        ...
        convertToBoolean.setRequirement(maxRowsFilter.getFilterOutcome(MaxRowsFilter.Category.VALID));
