...
public class SchedulingServiceConfiguration {
    ...
    private boolean _tenantInitialization;

    /**
     * Default constructor - creates a {@link SchedulingServiceConfiguration}
     * with defaults set.
     */
    public SchedulingServiceConfiguration() {
        _tenantInitialization = true;
    }
