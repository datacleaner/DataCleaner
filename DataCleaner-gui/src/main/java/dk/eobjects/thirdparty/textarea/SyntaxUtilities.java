...
import dk.eobjects.thirdparty.textarea.tokermarkers.Token;
...
public class SyntaxUtilities {
	...
	public static SyntaxStyle[] getDefaultSyntaxStyles() {
		...
		styles[Token.COMMENT1] = new SyntaxStyle(Color.CYAN, true, false);
		styles[Token.COMMENT2] = new SyntaxStyle(Color.CYAN.brighter(), true,
				false);
		styles[Token.KEYWORD1] = new SyntaxStyle(Color.BLACK, false, true);
		styles[Token.KEYWORD2] = new SyntaxStyle(Color.BLUE, false, false);
		styles[Token.KEYWORD3] = new SyntaxStyle(Color.GREEN.darker().darker(),
				false, false);
		styles[Token.LITERAL1] = new SyntaxStyle(Color.CYAN.darker().darker(),
				false, false);
		styles[Token.LITERAL2] = new SyntaxStyle(Color.CYAN.darker().darker(),
				false, true);
		styles[Token.LABEL] = new SyntaxStyle(Color.RED.darker(), false, true);
